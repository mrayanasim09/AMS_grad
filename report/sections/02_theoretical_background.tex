...
\subsection{The Breakdown of the Telescoping Sum ($\Gamma_t \not\succeq 0$)}
...
\begin{equation}
    \sum_{t=1}^T \langle g_t, x_t - x^* \rangle \le \frac{1}{2} \| x_1 - x^* \|_{V_1}^2 + \frac{1}{2} \sum_{t=2}^T \langle x_t - x^*, \Gamma_t (x_t - x^*) \rangle + \frac{1}{2} \sum_{t=1}^T \| g_t \|_{V_t^{-1}}^2,
